insert into realEstateArea (id) values (1);
insert into realEstateArea (id) values (2);

insert into realEstateInfo (id, timestamp, owner_account_id, source_account_id, target_account_id, amount)
